        ...
        <div className="containers">
           ...
           <div className=" flex-col flex sm:flex-row items-center justify-between pt-[129px] pb-[39px] border-b-[1px] border-b-[#D092BA] w-full">
            ...
            <div className="sm:w-[819px] w-[400px] bg-white rounded-[20px] sm:flex-row flex-col flex items-center justify-around ">
                <p className="font-normal text-[16px] leading-[15pxss] sm:text-[24px] sm:leading-[36px] p-[39px] text-[#242F65] ">Interested in working together? Drop me a line</p>
                <a className="flex px-4 items-center gap-[10px] w-[100px] sm:w-[187px] rounded-[10px] bg-[#242F65] border-[2px] text-white cursor-pointer border-[#242F65] hover:bg-transparent hover:text-[#242F65] duration-300" href="#"><BtnIcon/> 
