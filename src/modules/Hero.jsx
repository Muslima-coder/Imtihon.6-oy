  ...
  return (
    <section className='hero-section'>
        <div className="containers">
            <h2 className=' text-[25px] leading-0 mt-[15px] mb-[3px] sm:mt-[23px] text-center font-normal sm:text-[100px] text-[rgba(36,47,101,1)] sm:leading-[130px] '>Tell your creativity to the world with <span className='text-[rgba(255,119,76,1)]'> UIUXer</span></h2>
